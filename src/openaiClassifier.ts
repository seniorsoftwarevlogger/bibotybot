...
const spamExamples = [
  ...
  "Всем привет, ищу помощников в кофейню. Уборка зоны выдачи, сервировка столов, в день 4500р + кофе и десерты бесплатно. Можно с 16 лет. Пишите в ЛС",
  "Готов купить ЮСДС tRc20. Гибко по времени. Беру крупно, мелочь не интересует.",
  `У меня остался материал по трейдингу, которым я уже не пользуюсь. В нем все коротко и по делу, эти материалы помогли мне начать в этой сфере. Сейчас они лежат без дела просто так.  Готов поделится за бесплатно, кому интересно - пишите✅`,
  `솔라나 에어드랍 ㄱㄱ💜
