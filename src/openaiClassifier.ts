...
export async function classifyMessageOpenAI(message: string): Promise<boolean> {
  const prompt = `
Определи, является ли следующее сообщение эротическим спамом, вовлечением в сомнительные предложения о сотрудничестве или предложение о работе. Учитывай следующие примеры спам-сообщений:
